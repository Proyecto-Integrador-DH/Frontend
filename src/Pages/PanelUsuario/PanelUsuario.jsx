    ...
    return (
        <div>
            ...
            <div className={AdminStyle.contenedor}>
                <div className={`${AdminStyle.tarjetasContainer} grid grid-col-1 md:flex`}>
                    <div className={AdminStyle.tarjetas}>
                        <h2>Listar Reservas</h2>
                        <Link to='/reservas'><Button className={AdminStyle.boton}>Clic aquí</Button></Link>
                    </div>
                    <div className={AdminStyle.tarjetas}>
                    ...
                    <div className={AdminStyle.tarjetas}>
                        ...
                        <Link to='/cliente'><Button className={AdminStyle.boton}>Clic aquí</Button></Link>
                    </div>
                </div>
            </div>
            <Footer />
