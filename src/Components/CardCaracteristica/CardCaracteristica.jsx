...
const CardCaracteristica = ({ caracteristica }) => {
  ...
  return (
    <div className="flex gap-4 m-12 justify-around">
     {caracteristicaSeleccionadas.map(feature => (
    <div className="rounded bg-pink-600 px-4 py-2 w-36 h-38" key={feature.id}>
      <h3 className="text-center p-2">{feature.nombre}</h3>
